...
function theme_update_styles() {
	...
	wp_register_style("css", 'http://fonts.googleapis.com/css?family=Open+Sans|Cuprum|Open+Sans+Condensed:700|PT+Sans&subset=latin,cyrillic', array(), false, "all");
...
function theme_comment($comment, $args, $depth) {
    ...
    <div class="comment-avatar"><?php echo str_replace (array('height="150"', 'width="150"', "height='150'", "width='150'"), array('height="100%"', 'width="100%"', "height='100%'", "width='100%'"), theme_get_avatar(array('id' => $comment, 'size' => 150))); ?></div>
