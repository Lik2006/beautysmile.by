...
resizeData['object1082158071'] = {
   responsive: [
                  { left: 0.96, top: 0.07, visible: true }, 
                  { left: 0.96, top: 0.07, visible: true }, 
                  { left: 0.96, top: 0.07, visible: true }, 
                  { left: 0.96, top: 0.07, visible: true }, 
                  { left: 0.96, top: 0.07, visible: true }, 
...
resizeData['object2056405240'] = {
   responsive: [
                  { left: 0.05, top: 0.86, visible: true }, 
                  { left: 0.05, top: 0.86, visible: true }, 
                  { left: 0.05, top: 0.86, visible: true }, 
                  { left: 0.05, top: 0.86, visible: true }, 
                  { left: 0.05, top: 0.86, visible: true }, 
...
resizeData['object293142124'] = {
   responsive: [
                  { left: 0.03, top: 0.07, visible: true }, 
                  { left: 0.03, top: 0.07, visible: true }, 
                  { left: 0.03, top: 0.07, visible: true }, 
                  { left: 0.03, top: 0.07, visible: true }, 
                  { left: 0.03, top: 0.07, visible: true }, 
...
resizeData['headline'] = {
   responsive: [
                  { left: 0.11, top: 0.15, visible: true }, 
                  { left: 0.11, top: 0.15, visible: true }, 
                  { left: 0.11, top: 0.15, visible: true }, 
                  { left: 0.11, top: 0.15, visible: true }, 
                  { left: 0.11, top: 0.15, visible: true }, 
...
resizeData['slogan'] = {
   responsive: [
                  { left: 0.09, top: 0.05, visible: true }, 
                  { left: 0.09, top: 0.05, visible: true }, 
                  { left: 0.09, top: 0.05, visible: true }, 
                  { left: 0.09, top: 0.05, visible: true }, 
                  { left: 0.09, top: 0.05, visible: true }, 
...
jQuery(function ($) {
    ...
    processElementMultiplyBg(".header", {
        ...
        "bgposition": "0 0",
        "images": "url('images/object2056405240.png'),url('images/object1082158071.png'),url('images/object1216658987.png'),url('images/object293142124.png'), ",
        "positions": "30px 231px,634px 36px,432px 185px,25px 34px, "
    });
});
if (typeof window.resizeData === 'undefined') window.resizeData = {};
